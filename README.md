...
if(NOT EXISTS "${CMAKE_BINARY_DIR}/conan.cmake")
  message(
    STATUS
      "Downloading conan.cmake from https://gitlab.c-epic.com/hvg/cicd/conan/cmake-conan/-/raw/master/conan.cmake?inline=false"
  )
  execute_process(
    COMMAND
      COMMAND wget --no-check-certificate -O "${CMAKE_BINARY_DIR}/conan.cmake"
              "https://gitlab.c-epic.com/hvg/cicd/conan/cmake-conan/-/raw/master/conan.cmake?inline=false"
